...
namespace Jin.PlatformSDK.Common.Device
{
    public class PlatformAndroidDevice : IPlatformDevice
    {
        public string Initialize()
        {
            ...
            message.scheme = PlatformDeviceData.INITIALIZE_SCHEME;
        ...
        public string GetLanguage()
        {
            ...
            message.scheme = PlatformDeviceData.GET_LANGUAGE_SCHEME;
        ...
        public string GetCountry()
        {
            ...
            message.scheme = PlatformDeviceData.GET_COUNTRY_SCHEME;
        ...
        public string GetDeviceStorageSpace()
        {
            ...
            message.scheme = PlatformDeviceData.GET_DEVICE_STORAGE_SPACE_SCHEME;
